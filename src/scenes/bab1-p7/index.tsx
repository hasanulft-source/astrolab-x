...
import { Scene5Numerasi }  from './Scene5Numerasi'
...
export const bab1p7Scenes: Scene[] = [
  ...
  { id:'presisi',  num:'scene_04', stage:'Presisi · Inti',            time:'~25:00', Component:Scene4Presisi,  nextLabel:'Lanjut: Hitung bersama'      },
  { id:'numerasi', num:'scene_05', stage:'Hitung Bersama · Inti',     time:'~20:00', Component:Scene5Numerasi, nextLabel:'Lanjut: Refleksi'            },
