...
export const bab7p3Scenes: Scene[] = [
  ...
  { id: 'gerhana', num: 'scene_03', stage: 'Gerhana · Inti', time: '~26:00', Component: Scene3Gerhana, nextLabel: 'Lanjut: Refleksi' },
  { id: 'refleksi', num: 'scene_04', stage: 'Pasang Surut · Penutup', time: '~14:00', Component: Scene4Refleksi },
]
