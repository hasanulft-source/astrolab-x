...
export const bab2p4Scenes: Scene[] = [
  ...
  { id:'banding',  num:'scene_04', stage:'Bandingkan · Inti',  time:'~17:00', Component:Scene4Banding,  nextLabel:'Lanjut: Refleksi'     },
  { id:'refleksi', num:'scene_05', stage:'Refleksi · Penutup', time:'~15:00', Component:Scene5Refleksi                                   },
]
