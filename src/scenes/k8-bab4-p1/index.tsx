...
export const k8bab4p1Scenes: Scene[] = [
  { id: 'hook', num: 'scene_01', stage: 'Hook · Pendahuluan', time: '~12:00', Component: Scene1Hook, nextLabel: 'Lanjut: P = F/A' },
  { id: 'rumus', num: 'scene_02', stage: 'Rumus · Inti', time: '~30:00', Component: Scene2Rumus, nextLabel: 'Lanjut: Penerapan' },
