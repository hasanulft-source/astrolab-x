...
export const k8bab3p3Scenes: Scene[] = [
  { id: 'hook', num: 'scene_01', stage: 'Hook · Pendahuluan', time: '~12:00', Component: Scene1Hook, nextLabel: 'Lanjut: 4 jenis' },
  { id: 'jenis', num: 'scene_02', stage: 'Jenis · Inti', time: '~28:00', Component: Scene2Jenis, nextLabel: 'Lanjut: Klasifikasi' },
